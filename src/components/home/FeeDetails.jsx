    ...
    return (
        <div className="flex flex-col justify-center items-center w-full my-6 py-6 px-4 bg-gradient-to-r from-yellow to-pink-600 text-white">
            ...
            <ul className="list-disc flex flex-col md:text-lg pl-4">
                <li>UG Students / PG Students / Research Scholars: <span className="font-semibold">5500INR*</span></li>
                <li>Faculty: <span className="font-semibold">5500INR*</span></li>
                <li>For Foreign Authors: <span className="font-semibold">$60</span></li>
